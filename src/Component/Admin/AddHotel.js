...
const AddHotel = () => {
    ...
    const onSubmit = data => {
        console.log(data)
        fetch('https://reservation-system-database.vercel.app/addAllHotel', {
            method: 'POST',
            ...
            <div className="mt-5 pt-5 w-50  container">
                <div className="border bg-gray pt-5 mt-5 rounded">
                    ...
                    <div className="mx-4 px-4 mb-5">
                        <h4 className="text-white">Add new hotel</h4>
                        <form onSubmit={handleSubmit(onSubmit)} className="">
                            <input {...register("title")} className="form-control " placeholder="Name of Hotel" />
